...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-blue-50 via-white to-blue-100">
      ...
      {/* Left Side - Branding */}
      <div className="hidden lg:flex lg:w-1/2 relative z-10 flex-col justify-center px-16 bg-gradient-to-br from-blue-600 to-blue-800">
        <div className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-3xl font-bold text-white">ContractPro</span>
          </div>
          ...
          <div className="space-y-4 pt-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-blue-100 text-lg">Capture & manage leads with photo uploads</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-blue-100 text-lg">Create professional quotes in minutes</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-blue-100 text-lg">Schedule jobs & manage your calendar</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-blue-100 text-lg">Track invoices & get paid faster</span>
            </div>
          </div>
        </div>
      </div>
