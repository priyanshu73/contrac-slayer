    ...
    features: [
      {
        ...
        body: "ContractorOps keeps cost, price, margin, and project scope connected so your team can make faster decisions without rebuilding spreadsheets.",
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        body: "ContractorOps can summarize customer communication into practical context: what they need, what was promised, open questions, and the next step.",
