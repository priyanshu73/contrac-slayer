...
export function GlobalSearch() {
  ...
  return (
    <div ref={rootRef} className="relative">
      <div className="flex h-10 w-72 items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 shadow-sm transition-colors focus-within:border-slate-400 lg:w-96">
