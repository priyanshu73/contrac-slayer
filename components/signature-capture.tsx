...
export function SignatureCapture({ customerName, onComplete, onClose, isSubmitting = false }: SignatureCaptureProps) {
      ...
      <Card className="w-full max-w-2xl rounded-t-2xl sm:rounded-2xl">
        <div className="p-6">
          ...
          <div className="mt-6 flex gap-3">
            ...
            <Button onClick={handleComplete} disabled={!agreedToTerms || isSubmitting} className="flex-1">
              {isSubmitting ? (
                <>
