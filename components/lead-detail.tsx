  ...
  const communications = [
    {
      id: 1,
      type: "note",
      content: "Initial contact made via phone. Customer interested in weekly lawn maintenance.",
    ...
    },
    {
      id: 2,
      type: "email",
      content: "Sent follow-up email with service packages and pricing information.",
