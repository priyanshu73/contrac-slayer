...
export function LeadsListReal() {
  ...
  if (leads.length === 0) {
    // Show mock lead when no real leads exist
    const mockLeads = [{
      id: 1,
      name: "Sarah Johnson",
      ...
      project_type: "Landscaping - Patio Installation",
      description: "Looking to install a new patio in backyard. 20x15 feet area with natural stone pavers.",
      status: "new",
      ...
      <div className="space-y-3">
        ...
        <Card className="p-4 border-dashed border-muted-foreground/30">
          <p className="text-center text-sm text-muted-foreground">
            Share your quote request page to get more leads!
          </p>
        </Card>
      </div>
    )
